                ...
                <div class="category-slider-inst">
                    ...
                    <div class="single-slider-item">
                        <div class="img-box bg"
                             <?php echo render_background_image_markup_by_attachment_id($category->image, 'grid', true); ?>
                        ...
                        >
                            <a href="<?php echo e(route('frontend.products.category', [
                                ...
                                <?php echo render_image_markup_by_attachment_id($category->image, '', 'grid', true); ?>
...
<?php /**PATH /home/mobidvab/public_html/core/app/Providers/../PageBuilder/views/product/category/slider_one.blade.php ENDPATH**/ ?>