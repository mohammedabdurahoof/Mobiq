                ...
                <div class="col-md-12">
                    <div class="d-flex align-items-center gap-4">
                        <?php $__currentLoopData = $category->subcategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a class="btn btn-sm sub-category-button" href="<?php echo e(route('frontend.products.subcategory', [
                               'id' => $subCat->id,
                               'any' => \Str::slug($subCat->title ?? '')
                           ])); ?>">
                                <?php echo render_image($subCat->subCategoryImage); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mobidvab/public_html/core/resources/views/frontend/pages/product/category.blade.php ENDPATH**/ ?>