                            ...
                            <div class="form-group" id="product-list">
                                ...
                                <select id="products" name="campaign" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == optional($selectedCampaign)->campaign_id ?? '' ? "selected" : ""); ?>><?php echo e($item->name); ?></option>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mobidvab/public_html/core/resources/views/backend/mobile-campaign/create.blade.php ENDPATH**/ ?>