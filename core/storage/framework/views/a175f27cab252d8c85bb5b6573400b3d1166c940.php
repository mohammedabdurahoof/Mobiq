...
<?php endif; ?>
                            <form action="<?php echo e(route('frontend.support.ticket.store')); ?>" method="post"
                                ...
                                <div class="btn-wrapper text-center">
                                    <button type="submit" class="cmn-btn0">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mobidvab/public_html/core/resources/views/frontend/user/dashboard/support-tickets/create.blade.php ENDPATH**/ ?>