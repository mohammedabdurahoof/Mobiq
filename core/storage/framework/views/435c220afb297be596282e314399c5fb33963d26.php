...
<?php endif; ?>
                                <form action="<?php echo e(route('user.dashboard.support.ticket.message')); ?>" method="post"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="info-text d-block text-danger"><?php echo e(__('Max file size 5MB, only jpeg, jpg, png, gif, pdf, doc, docx, zip file is allowed')); ?></small>
                                    </div>
                                    <div class="form-group">
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mobidvab/public_html/core/resources/views/frontend/user/dashboard/support-tickets/view.blade.php ENDPATH**/ ?>