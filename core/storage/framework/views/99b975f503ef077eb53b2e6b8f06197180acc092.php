            ...
            <div class="login-box ptb--100">
                <form method="POST" action="<?php echo e(route('admin.login')); ?>">
                    ...
                    <div class="login-form-body">
                        ...
                        <?php if(preg_match('/(shopmartecommerce)/',url('/'))): ?>
...
<?php echo $__env->make('layouts.login-screens', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mobidvab/public_html/core/resources/views/auth/admin/login.blade.php ENDPATH**/ ?>