...
class NewsUpdatePageStyleOne extends PageBuilderBase
{
    ...
    {
        return __('Page: Blog News Update');
    }
    ...
    public function frontend_render(): string
    {
        ...
        $read_more_btn_text = SanitizeInput::esc_html($this->setting_item('read_more_btn_text')) ?? __('Read More');
...
HTML;
    ...
    private function renderNewsUpdateMarkup($blog = null, $read_more_btn_text): string
    {
        $settings = $this->get_settings();
        ...
        $blog_summary = Str::words($blog->blog_content, 20);
