...
class QuoteStyleOne extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $faq_markup = '';
        $faq_items = Faq::query()->where('status', 'publish');
        ...
        $section_data = [
            ...
            'faq_items' => $faq_items,
            'ask_question_form_title' => $ask_question_form_title,
            'custom_form_markup' => $custom_form_markup
        ];

        return $this->renderBlade('common.faq_style_one', $section_data);
