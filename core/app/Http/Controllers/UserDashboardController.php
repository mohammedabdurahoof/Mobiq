...
class UserDashboardController extends Controller
{
    ...
    public function user_index()
    {
        ...
        return view(self::BASE_PATH . 'user-home', compact('product_count', 'support_ticket_count', 'all_orders'));
    }
    ...
    public function cancelOrder(ProductSellInfo $item)
    {
        $item->update(['status'=>'canceling']);
        return back();
    }
    ...
    public function support_ticket_message(Request $request)
    {
        $this->validate($request, [
            ...
            'file' => 'nullable|mimes:zip,jpeg,jpg,png,gif,pdf,doc,docx|max:5120',
            //  this 5120 is represented 5mb because max only except kbs number for that we have to give multiply mb to kbs like 1 mb * 1024
        ]);
