...
<script>
    (function ($) {
        ...
        $('body').on('click', '.media-uploader-image-list > li', function (e) {
            ...
            $('.img_alt_submit_btn').html('<i class="@if($type === 'admin') fas fa-check @else las la-check @endif"></i>');
        ...
        $(document).on('click', '.img_alt_submit_btn', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('.img_alt_submit_btn').html('<i class="@if($type === 'admin') fas fa-check-circle @else  las la-check-circle  @endif"></i>');
