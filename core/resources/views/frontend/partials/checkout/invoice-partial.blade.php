        ...
        <div class="item-description">
            ...
            <table class="custom--table">
                ...
                @foreach($order_details->sale_details as $sale)
                    <tr>
                        <td>{{ optional($sale->product)->title }} {{ getItemAttributesName($sale->attributes) }}</td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if(!empty($order_details->payment_gateway))
                                    <span class="data-span"> {{ __('Payment Gateway:') }} </span> {{ ucwords(str_replace("_", " ", $order_details->payment_gateway)) }}
                                    <br>
                                @endif
