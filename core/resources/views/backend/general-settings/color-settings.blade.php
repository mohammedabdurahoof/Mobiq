                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{route('admin.general.color.settings')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="site_special_color">{{__('Site Special Color Settings')}}</label>
                                <input type="text" name="site_special_color" style="background-color: {{get_static_option('site_special_color')}};color: #fff;" class="form-control" value="{{get_static_option('site_special_color')}}" id="site_special_color">
                                <small>{{__('you change site special color from here, it will replace website special color')}}</small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="site_form_bg_color" style="background-color: {{get_static_option('site_form_bg_color')}};color: #fff;" class="form-control" value="{{get_static_option('site_form_bg_color')}}" id="site_form_bg_color">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="site_footer_bg_color" style="background-color: {{get_static_option('site_footer_bg_color')}};color: #fff;" class="form-control" value="{{get_static_option('site_footer_bg_color')}}" id="site_footer_bg_color">
                                <small>{{__('you can change site paragraph color from there')}}</small>
                            </div>
