    ...
    <div class="col-lg-12 col-ml-12 padding-bottom-30">
        <div class="row">
            ...
            <div class="col-lg-6 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">{{ __('Top-bar Menu') }}</h4>
                        @can('top-bar-menu-update')
                        <form action="{{ route('admin.topbar.select.menu') }}" method="post">
                            ...
                            <div class="text-right">
                                <button class="btn btn-primary" type="submit">{{ __('Update Top-bar Menu') }}</button>
                            </div>
                        </form>
                        @endcan
                    </div>
                            ...
                            <tbody>
                                @foreach ($all_social_icons as $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->url }}</td>
                                        <td>
                                            @can('top-bar-social-icon-delete')
