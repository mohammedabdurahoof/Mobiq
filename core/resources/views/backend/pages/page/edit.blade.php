                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <div class="navbar_variants mt-5">
                                        ...
                                        @for($i = 1; $i <= 2; $i++)
                                            <div class="img-select img-select-nav @if($page_post->navbar_variant == $i) selected @endif" data-navbar_id="{{ $i }}">
                                                <div class="img-wrap">
                                                    <img src="{{ asset('assets/frontend/navbar-variant/0'.$i.'.jpg') }}" data-nav_id="{{ $i }}" alt="">
                                                </div>
                                            </div>
                                        @endfor
                                    </div>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="switch role">
                                            <input type="checkbox" name="navbar_category_dropdown_open" @if(!empty($page_post->navbar_category_dropdown_open)) checked @endif>
                                            <span class="slider-yes-no"></span>
                                        </label>
                                    </div>
                                    {{-- =================================================END====================================================== --}}
                                    ...
                                    <div class="form-group" id="megamenu" style="display: {{ $page_post->navbar_variant != 1 ? "none!important" : "block" }}">
                                        <label>{{__('Select Mega Menu')}}</label>
                                        <select name="megamenu" class="form-control">
                                            @foreach($mega_menu_categories as $key => $value)
                                                <option value="{{ $key }}" {{ $key == $selected_megamenu ? "selected" : "" }}>{{ html_entity_decode($value) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
